...
public class SVG {
    ...
    public SVG(double longitud, double altura) {
        ...
        concatenar(String.format("<svg width=\"%.2f\" height=\"%.2f\" xmlns=\"http://www.w3.org/2000/svg\">", longitud, altura));
        nivel = 1;
    }
    ...
    public void agregarLinea(Linea linea) {
      concatenar("<line x1= \""+linea.getP1().getX()+"\" y1=\""+(altura-linea.getP1().getY())+
     "\" x2=\""+linea.getP2().getX()+"\" y2=\""+(altura-linea.getP2().getY())+"\" style=\"stroke: black; stroke-width: 1; fill: none \"/>");
    }
    ...
    public void agregarTriangulo(Triangulo triangulo) {
      agregarLinea(new Linea(triangulo.getPa(),triangulo.getPb()));
      agregarLinea(new Linea(triangulo.getPb(),triangulo.getPc()));
      agregarLinea(new Linea(triangulo.getPc(),triangulo.getPa()));
    }
